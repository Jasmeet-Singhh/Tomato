...
const LoginPopup = ({ setShowLogin }) => {
  ...
  return (
    <div className={styles["login-popup"]}>
      <form className={styles["login-popup-container"]}>
        <div className={styles["login-popup-title"]}>
          <h2>{currState}</h2>
          <img onClick={() => setShowLogin(false)} src={assets.cross_icon} alt="" />
        </div>
        <div className={styles["login-popup-inputs"]}>
        ...
        <div className={styles["login-popup-condition"]}>
